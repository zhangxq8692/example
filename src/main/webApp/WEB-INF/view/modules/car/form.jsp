    ...
    <div>
        ...
        <form:form modelAttribute="user" class="form-horizontal" action="${ctxPath}/user/update">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="inputName" name="name" placeholder="姓名" value="${user.name}" readonly/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="inputAge">年龄</label>
                <div class="controls">
                    <input type="text" id="inputAge" name="age" placeholder="年龄" value="${user.age}" readonly/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="inputSex">性别</label>
                <div class="controls">
                    <input type="text" id="inputSex" name="sex" placeholder="性别" value="${user.sex}" readonly/>
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
